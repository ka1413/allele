...
public class MainDemo_with_buttons extends JFrame implements ActionListener,
	...
	public MainDemo() throws Exception {
		db.loadFromFile("sample.dat"); // TODO JFileChooser
		...
		// configure default length of columns of table1 and table2
		...
		view.add(new JScrollPane(table1),BorderLayout.CENTER);
		view.add(new JButton("Add Species"),BorderLayout.SOUTH);

		scrollPane2 = new JScrollPane(view2);
		view2.add(new JScrollPane(table2),BorderLayout.CENTER);
		view2.add(new JButton("Add tRNA"),BorderLayout.SOUTH);
	...
	public void actionPerformed(ActionEvent x) {
		...
		if (x.getActionCommand() == "Save As...") { // TODO JFileChooser
			//FileChooser chooser = new FileChooser(1);
			//chooser.createAndShowGUI(2);
		}
	...
	public void mouseClicked(MouseEvent me) {
		...
		if (table1.equals(table)) {
			...
			if (group.getSelection().getActionCommand().equals("allMode")) {
				// configure default length of columns of table2
				TableColumn column = null;
				for (int i = 0; i < 4; i++) {
					column = table2.getColumnModel().getColumn(i);
					if (i == 0) {
