...
public class TrnaDatabase {
	/*Node head;
	Node rover = new Node();
	Node rover2 = new Node();
	Node i = new Node();
	Node nodeCopy;
	boolean lastNode = false;*/

    Species head, rover = new Species(), rover2 = new Species(), i = new Species(), nodeCopy;
    boolean lastNode = false;
    File databaseFile;
    ...
    /*public void equals(TrnaDatabase abc){
        if(abc.head == null){
            this.head = null;
        }
        else{
    ...
    /*public boolean equals(TrnaDatabase db){
